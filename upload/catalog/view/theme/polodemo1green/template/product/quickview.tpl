...
<!-- <script src="catalog/view/theme/polodemo1green/js/jquery.flexslider.js" type="text/javascript"></script>


<link href="catalog/view/theme/polodemo1green/stylesheet/flexslider.css" rel="stylesheet"> -->
