...
<!-- <script src="catalog/view/theme/polodemo1red/js/jquery.flexslider.js" type="text/javascript"></script>


<link href="catalog/view/theme/polodemo1red/stylesheet/flexslider.css" rel="stylesheet"> -->
