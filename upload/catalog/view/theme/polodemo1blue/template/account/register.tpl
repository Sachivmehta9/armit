        ...
        <div class="progress-container">
          <div class="checkout-wrap">
            <ul class="checkout-bar">
              <li class="visited first activated"><a href="#">SIGN UP | LOGIN</a></li>
...
<div class="main-container col2-right-layout wow bounceInUp animated">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="col-sm-12 col-main"><?php echo $content_top; ?>
      <div class="row">
        <div class="col-sm-12">
          <h1 class="registerh1">Register new device</h1>
          <h4 class="registerh4">To select device enter Activation code into the field below:</h4>
        </div>        
      </div>
      <div class="row">
        <div class="col-sm-12">
        <div class="col-sm-12 registermargin">
        <div class="row">
        <div class="col-sm-2">
        </div>
        <div class="col-sm-4">
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="activation-form">
            <p class="activation-text">
              <span class="line1">Enter your Activation code ? IMEI number in the field below.</span>
              <span>IMEI on his device that is printed on packaging and pay for service</span>
              <span>activation = validate IMEI/select service/pay service/activate IMEI</span>
            </p>
            <div class="form-group">
              <div class="input-group cuatom-activation-group">
                <input type="text" name="activation" value="" placeholder="ACTIVATION CODE    |    IMEI NUMBER" id="input-email" class="form-control custom-form-control margin0 field input-iemi" />
              </div>
            </div>
            <div class="form-group login text-center">
              <button type="submit" class="button letsgo btn-lg btn-circle submit-form-contact colorblack"><i class="glyphicon Glyphicons Halflings"></i>Next</button>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            <p class="anti-upper-title">MotionCam Pro | White</p>
            <div class="input-group cuatom-activation-group anti-group">
              <img src="catalog/view/theme/polodemo1blue/image/anti-alarm.png" class="anti-img">
            </div>
            <p class="not-device-text"><a href="#">not your device?</a></p>
          </div>
        </div>
        </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-10">
          <h1 class="Welcome-text">
              Welcome aboard, we appreciate your business,
              be sure to check out your <span class="myarmit-font">myArmit,</span> all on one platform.
          </h1>
        </div>
        <div class="col-sm-1"></div>
      </div>
