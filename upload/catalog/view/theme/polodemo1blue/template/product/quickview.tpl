...
<!-- <script src="catalog/view/theme/polodemo1blue/js/jquery.flexslider.js" type="text/javascript"></script>


<link href="catalog/view/theme/polodemo1blue/stylesheet/flexslider.css" rel="stylesheet"> -->
