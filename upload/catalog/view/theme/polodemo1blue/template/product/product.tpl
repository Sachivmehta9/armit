<?php global $config; echo $header; ?>
  ...
  <section class="main-container col1-layout wow animated">
          ...
          <div class="product-essential">
            ...
            <div class="product-img-box col-lg-6 col-sm-6 col-xs-12">
              <?php /* if($config->get('magikpolo_sale_label')==1) { 
                        if ($price && $special) { ?>
                        <div class="sale-label new-top-left"><?php echo $config->get('magikpolo_sale_labeltitle'); ?></div>
                        <?php } } */ ?>
            ...
            <?php if ($thumb) { ?>
                ...
                <img class="moreview_thumb_image" src="<?php echo $popup; ?>"> 
                <img class="moreview_source_image" src="<?php echo $popup; ?>" alt=""> 
                <span class="roll-over">Roll over image to zoom in</span> 
                <img style="position: absolute;" class="zoomImg" src="<?php echo $popup; ?>">
                </li>
            <?php } ?>
            ...
            <?php foreach ($images as $image) { ?>
                <li class="moreview_thumb thumb_6"> 
                <img class="moreview_thumb_image" src="<?php echo $image['popup']; ?>"> 
                <img class="moreview_source_image" src="<?php echo $image['popup']; ?>" alt=""> 
                <span class="roll-over">Roll over image to zoom in</span> 
                <img style="position: absolute;" class="zoomImg" src="<?php echo $image['popup']; ?>">
                </li>
            <?php } ?>
            <?php } ?>
...
<!--               <div class="form-group">
          ...
          <?php /* global $config; if ($config->get('magikpolo_productpage_cb')) { ?>
          <div class="col-sm-3 col-xs-12 hot-banner">
            <?php echo html_entity_decode($config->get('magikpolo_productpage_cbcontent'));?>
        </div>
          <?php } */ ?>    
          ...
          <div class="product-collateral">
            <div class="col-sm-12 bounceInUp animated">
              ...
              <?php global $config; if ($config->get('magikpolo_product_ct')) { ?>
              <li><a href="#product_tabs_custom" data-toggle="tab"><?php echo $config->get('magikpolo_product_cttitle'); ?></a></li>
              <?php }?>

              <?php if ($config->get('magikpolo_product_ct2')) { ?>
              <li><a href="#product_tabs_custom1" data-toggle="tab"><?php echo $config->get('magikpolo_product_ct2title'); ?></a></li>
              <?php }?>
            ...
            <?php if ($config->get('magikpolo_product_ct')) { ?>
            <div class="tab-pane fade" id="product_tabs_custom">
            <?php echo html_entity_decode($config->get('magikpolo_product_ctcontent'));?>
            </div>
            <?php } ?>

            <?php if ($config->get('magikpolo_product_ct2')) { ?>
            <div class="tab-pane fade" id="product_tabs_custom1">
            <?php echo html_entity_decode($config->get('magikpolo_product_ct2content'));?>
            </div>
            <?php } ?> 
