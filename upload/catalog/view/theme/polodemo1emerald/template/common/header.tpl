...
<link href="catalog/view/theme/polodemo1emerald/js/fancybox/jquery.fancybox.css" rel="stylesheet">
<script src="catalog/view/theme/polodemo1emerald/js/fancybox/jquery.fancybox.js" type="text/javascript"></script>
...
<link href="catalog/view/theme/polodemo1emerald/stylesheet/animate.css" rel="stylesheet">
<?php } ?>
<link href="catalog/view/theme/polodemo1emerald/stylesheet/stylesheet.css" rel="stylesheet">
<link href="catalog/view/theme/polodemo1emerald/stylesheet/font-awesome.css" rel="stylesheet">

<link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/owl-carousel/owl.carousel.css">
<link href="catalog/view/theme/polodemo1emerald/stylesheet/style.css" rel="stylesheet">
<!-- <link href="catalog/view/theme/polodemo1emerald/stylesheet/jquery.fancybox.css" rel="stylesheet"> -->
...
<script src="catalog/view/theme/polodemo1emerald/js/parallax.js" type="text/javascript"></script>
<script src="catalog/view/theme/polodemo1emerald/js/common.js" type="text/javascript"></script>
<script src="catalog/view/theme/polodemo1emerald/js/common1.js" type="text/javascript"></script>
<script src="catalog/view/theme/polodemo1emerald/js/cloudzoom.js" type="text/javascript"></script>
...
<div id="mgkquickview">
<div id="magikloading" style="display:none;text-align:center;margin-top:400px;"><img src="catalog/view/theme/polodemo1emerald/image/loading.gif" alt="loading">
</div></div>