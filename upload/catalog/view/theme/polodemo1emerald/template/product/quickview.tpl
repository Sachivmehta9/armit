...
<!-- <script src="catalog/view/theme/polodemo1emerald/js/jquery.flexslider.js" type="text/javascript"></script>


<link href="catalog/view/theme/polodemo1emerald/stylesheet/flexslider.css" rel="stylesheet"> -->
